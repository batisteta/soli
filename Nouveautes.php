...
<html>
	<head>
		<title> Vidéos de recettes </title>
		<meta charset="utf-8"/>
		...
		<div>
			...
			<mark><center><h1>Les Recettes en vidéo</h1></center></mark>
			</form>
		</div>
		<br/>
			<center>
				<video width="400" controls>
				<source src="VideoViande.mp4" type="video/mp4">
				<source src="videoViande.ogg" type="video/ogg">
